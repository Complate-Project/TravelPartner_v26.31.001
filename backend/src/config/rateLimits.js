...
/* ── Password reset (public, IP-based) ── */
const forgotPasswordLimiter = makeLimiter({ windowMs: 15 * 60 * 1000, limit: 3 });
const verifyOtpLimiter = makeLimiter({ windowMs: 15 * 60 * 1000, limit: 5 });
const resendOtpLimiter = makeLimiter({ windowMs: 60 * 1000, limit: 1 });
const resetPasswordLimiter = makeLimiter({ windowMs: 15 * 60 * 1000, limit: 3 });
