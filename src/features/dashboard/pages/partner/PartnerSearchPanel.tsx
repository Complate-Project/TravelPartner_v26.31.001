    ...
    return (
        <div
            style={{
                ...
                boxShadow: "0 0 0 3px rgba(212,167,44,0.08)",
            }}
        >
            {profile.avatar_url ? (
                <MediaImage
...
function ProfileCard({
    ...
    return (
        <motion.div
            ...
            whileHover={{ y: -2 }}
        >
            <div style={{ position: "absolute", top: 0, left: "20%", right: "20%", height: 1, background: "linear-gradient(90deg, transparent, var(--gold-mid), transparent)", opacity: 0.5 }} />
            ...
            <div style={{ display: "flex", gap: 8, marginTop: 14 }} onClick={(e) => e.stopPropagation()}>
                ...
                <button
                    ...
                    style={{
                        flex: 1,
                        padding: "10px",
                        background: canRequest ? "linear-gradient(135deg, var(--gold-rich), var(--gold-mid))" : "rgba(212,167,44,0.15)",
                        border: "none",
                        borderRadius: 9,
                        ...
                        boxShadow: canRequest ? "0 0 14px rgba(212,167,44,0.3)" : "none",
                    }}
                >
        ...
        <div style={{
            ...
            >
                <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                    ...
                    {activeCount > 0 && (
                        <span style={{
                            background: "var(--gold-mid)", color: "#fff", borderRadius: 999,
                                        ...
                                        return (
                                            <button
                                                ...
                                                style={{
                                                    padding: "6px 12px",
                                                    borderRadius: 999,
                                                    border: `1px solid ${active ? "var(--gold-mid)" : "var(--border-subtle)"}`,
