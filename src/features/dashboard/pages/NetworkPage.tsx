...
export function NetworkPage() {
    ...
    useEffect(() => {
        ...
        setReferralUrl(`https://travelpartner.app/login.php?ref=${referralCode}`);
    }, [user?.id, user?.role]);
            ...
            <div style={{
                    ...
                    {[
                        ...
                        <div key={idx} style={{
                            ...
                            <span style={{
                                ...
                                textShadow: '0 0 16px rgba(212,167,44,0.25)',
                            }}>
                                {stat.value}
                            </span>
                        </div>
                ...
                <motion.div variants={fadeUp} style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: 'clamp(14px, 4vw, 20px)' }}>
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="var(--gold-mid)" strokeWidth="2" style={{ flexShrink: 0 }}>
                    ...
                    <div style={{
                        ...
                        <button
                            ...
                            style={{
                                ...
                                background: copied
                                    ? 'var(--green-status)'
                                    : 'linear-gradient(135deg, var(--gold-rich), var(--gold-mid))',
                                border: 'none',
                                borderRadius: '8px',
                                color: '#ffffff',
                    ...
                    <div>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: 'clamp(12px, 3.5vw, 16px)' }}>
                            {[
                                ...
                                { level: "5 Referral Purchases:",  text: "Elite Tier + 5,000 Bonus",            color: 'var(--gold-mid)',   symbol: "💎" },
                                { level: "Lifetime Benefits:",     text: "Unlocked networks are permanent.",      color: 'var(--gold-mid)',   symbol: "∞"  },
                            ].map((reward, i) => (
                                <div key={i} style={{
                                    display: 'flex',
