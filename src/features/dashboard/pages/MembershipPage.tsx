            ...
            <div style={{ padding: '100px 16px 16px', maxWidth: '900px', margin: '0 auto' }}>
                ...
                {membership && (
                    <motion.div variants={fadeUp} style={{
                        background: 'linear-gradient(135deg, rgba(212,167,44,0.08), rgba(139,92,246,0.08))',
                        border: '1px solid rgba(212,167,44,0.2)',
                        borderRadius: 16, padding: '20px 24px', marginBottom: 24,
                    }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 12 }}>
                            <div>
                                <p style={{ margin: '0 0 4px', fontSize: '0.6rem', letterSpacing: '0.14em', textTransform: 'uppercase', color: 'var(--text-muted)', fontWeight: 700 }}>Current Plan</p>
