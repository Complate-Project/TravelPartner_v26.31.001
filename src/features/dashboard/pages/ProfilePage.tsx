...
const goldButtonStyle: React.CSSProperties = {
    ...
    boxShadow: "0 4px 20px rgba(212, 167, 44, 0.2)",
};

const onGoldEnter = (e: React.MouseEvent<HTMLButtonElement>) => {
    e.currentTarget.style.filter = "brightness(1.1)";
    e.currentTarget.style.transform = "translateY(-1px)";
    e.currentTarget.style.boxShadow = "0 6px 28px rgba(212, 167, 44, 0.35)";
};

const onGoldLeave = (e: React.MouseEvent<HTMLButtonElement>) => {
    e.currentTarget.style.filter = "none";
    e.currentTarget.style.transform = "none";
    e.currentTarget.style.boxShadow = "0 4px 20px rgba(212, 167, 44, 0.2)";
};
                                                                            ...
                                                                            interestsArr.map((interest) => (
                                                                                <span
                                                                                    ...
                                                                                    style={{
                                                                                        ...
                                                                                        borderRadius: 999,
                                                                                        background:
                                                                                            "linear-gradient(135deg, rgba(212,167,44,0.18), rgba(212,167,44,0.06))",
                                                                                        border: "1px solid var(--border-subtle)",
                                                                                        color: "var(--text-primary)",
                                                                                        fontWeight: 800,
                                                                                        fontSize: "0.8rem",
