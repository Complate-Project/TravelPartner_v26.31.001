                        ...
                        {events.map((ev, i) => (
                            <div
                                ...
                                style={{
                                    ...
                                    boxShadow: '0 0 15px rgba(212,167,44,0.2)',
                                }}
                            >
                                <div style={{
                                    width: '100%',
                                    ...
                                    <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="var(--gold-mid)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" style={{ filter: 'drop-shadow(0 0 5px rgba(96,165,250,0.6))' }}>
                                ...
                                <div style={{ padding: '12px 10px' }}>
                                    ...
                                    <div style={{ display: 'flex', alignItems: 'center', gap: '5px', marginBottom: '5px' }}>
                                        <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="var(--gold-mid)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                            <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" />
                                            <circle cx="12" cy="10" r="3" />
                                        </svg>
                                        <span style={{ color: 'var(--gold-mid)', fontSize: '0.65rem', fontWeight: 600, fontFamily: "'Inter', sans-serif" }}>
                                            {ev.location}
                                        </span>
                                    </div>
