    ...
    return (
        <div style={{ paddingBottom: '8px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px' }}>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="var(--gold-mid)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0, filter: 'drop-shadow(0 0 5px rgba(96,165,250,0.6))' }}>
                ...
                {!loading && locations.map(loc => (
                    ...
                    >
                        <div style={{
                            ...
                            <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="var(--gold-mid)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                        ...
                        <div style={{
                            ...
                            <p style={{ color: 'var(--gold-mid)', fontSize: 'clamp(0.58rem, 2vw, 0.65rem)', letterSpacing: '0.1em', textTransform: 'uppercase', fontFamily: "'Inter', sans-serif", fontWeight: 700, marginBottom: '5px', textShadow: '0 0 5px rgba(96,165,250,0.5)' }}>
