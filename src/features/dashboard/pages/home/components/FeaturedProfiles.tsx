                ...
                {!loading && profiles.map(p => {
                    ...
                    <div
                        ...
                        style={{
                            ...
                            borderRadius: '12px',
                            overflow: 'hidden',
                            border: isUser ? '2px solid var(--gold-mid)' : '2px solid var(--gold-mid)',
                            position: 'relative',
                            cursor: 'pointer',
                    ...
                    >
                        ...
                        <div style={{
                            ...
                            <p style={{ color: isUser ? 'var(--gold-mid)' : 'var(--gold-mid)', fontSize: 'clamp(0.6rem, 2.5vw, 0.7rem)', fontWeight: 600, fontFamily: "'Inter', sans-serif", textShadow: isUser ? '0 0 5px rgba(232,160,32,0.5)' : '0 0 5px rgba(96,165,250,0.5)' }}>
