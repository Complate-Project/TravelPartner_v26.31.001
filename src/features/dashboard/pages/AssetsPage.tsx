                ...
                <div style={{
                        ...
                        <div style={{
                            ...
                            {[
                                ...([{
                                    ...
                                    icon: (
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="var(--gold-mid)" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                                ...
                                <button key={btn.label} onClick={btn.onClick} style={{
                                    ...
                                    onMouseEnter={e => {
                                        e.currentTarget.style.borderColor = 'var(--gold-rich)';
                    ...
                    <div style={{
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '24px' }}>
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="var(--gold-mid)" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                                ...
                                {transactions.slice(0, visibleCount).map((tx) => {
                                    ...
                                    const iconBg =
                                        tx.type === "withdraw" || tx.type === "event_payment"
                                            ...
                                            : tx.type === "deposit"
                                            ? `rgba(212, 167, 44, ${isPending ? "0.08" : "0.15"})`
                                            : `rgba(212, 167, 44, ${isPending ? "0.08" : "0.15"})`;
                                    const iconColor =
                                    ...
                                    return (
                                        <div key={tx.id} style={{
                                            ...
                                            background: isPending ? "rgba(212,167,44,0.03)" : isRejected ? "rgba(239,68,68,0.03)" : "var(--bg-input)",
                                            border: isPending ? "1px solid rgba(212,167,44,0.25)" : isRejected ? "1px solid rgba(239,68,68,0.2)" : "1px solid var(--border-subtle)",
                                            borderRadius: '12px',
                                            padding: '16px 20px',
                                                        ...
                                                        {tx.admin_note && (
                                                            <span
                                                                ...
                                                                style={{
                                                                    ...
                                                                    padding: "2px 7px",
                                                                    borderRadius: "20px",
                                                                    background: copiedId === tx.admin_note ? "rgba(16,185,129,0.15)" : "rgba(212,167,44,0.1)",
                                                                    color: copiedId === tx.admin_note ? "var(--green-status)" : "var(--gold-mid)",
                                                                    border: `1px solid ${copiedId === tx.admin_note ? "rgba(16,185,129,0.3)" : "rgba(212,167,44,0.2)"}`,
                                                                    cursor: "pointer",
                                                                    display: "inline-flex",
                                                                    alignItems: "center",
                                                                    gap: "4px",
            ...
            {showDepositModal && (
                <div style={{
                    ...
                    <form onSubmit={handleDeposit} style={{
                        ...
                        {modalError && (
                            <div style={{ padding: '8px 12px', background: 'rgba(239,68,68,0.1)', border: '1px solid rgba(239,68,68,0.3)', borderRadius: '6px', color: 'var(--red-status)', fontSize: '0.78rem' }}>
                                {modalError}
                            </div>
                        )}
                        ...
                        <div style={{ display: 'flex', gap: '12px', justifyContent: 'flex-end' }}>
                            ...
                            <button type="submit" disabled={modalLoading} style={{ padding: '10px 20px', background: 'linear-gradient(135deg, var(--gold-rich), var(--gold-mid))', border: 'none', borderRadius: '6px', color: '#fff', cursor: 'pointer', fontSize: '0.75rem', fontWeight: 700 }}>
