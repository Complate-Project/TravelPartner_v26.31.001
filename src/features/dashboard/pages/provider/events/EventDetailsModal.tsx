    ...
    return (
        <div style={{
            ...
            <div style={{
                ...
                padding: '24px 20px',
                boxShadow: '0 0 40px rgba(212,167,44,0.12), var(--shadow-lg)',
                display: 'flex',
                    ...
                    {role === 'provider' && (
                        <div>
                            ...
                            {loadingParticipants ? (
                                ...
                                <p style={{ fontSize: '0.82rem', color: 'var(--text-muted)', margin: 0, padding: 8, border: '1px dashed var(--border-default)', borderRadius: 6, textAlign: 'center' }}>
