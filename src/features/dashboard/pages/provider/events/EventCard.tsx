...
export function EventCard({
    ...
    return (
        ...
        onMouseEnter={e => {
            ...
            e.currentTarget.style.boxShadow = '0 0 24px rgba(212,167,44,0.12)';
        }}
        onMouseLeave={e => {
                        ...
                        hasJoined ? (
                            ...
                            <>
                                ...
                                <button
                                    ...
                                    style={{
                                        background: isFull || isApplicationsClosed ? 'var(--bg-input)' : 'linear-gradient(135deg, var(--gold-rich), var(--gold-deep))',
                                        border: isFull || isApplicationsClosed ? '1px solid var(--border-default)' : '1px solid var(--border-default)',
                                        borderRadius: 'var(--radius-md)',
                                        ...
                                        boxShadow: isFull || isApplicationsClosed ? 'none' : '0 0 14px rgba(212,167,44,0.25)',
                                        transition: 'all 0.2s'
                                    }}
                                >
