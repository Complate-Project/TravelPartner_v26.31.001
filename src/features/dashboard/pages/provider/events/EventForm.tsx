...
const SpinnerIcon = () => (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" style={{ animation: 'spin 0.8s linear infinite' }}>
        <circle cx="12" cy="12" r="9" stroke="rgba(11,15,26,0.35)" strokeWidth="3" />
        <path d="M21 12a9 9 0 0 0-9-9" stroke="#0b0f1a" strokeWidth="3" strokeLinecap="round" />
    </svg>
);

/* ============================================================
   SHARED STYLES — gold/blue Travel Partner design system
   ============================================================ */
            ...
            <div style={{ display: 'flex', gap: 12, justifyContent: 'flex-end', marginTop: 4 }}>
                ...
                <button
                    ...
                    style={{
                        ...
                        fontFamily: "'Inter', sans-serif",
                        boxShadow: '0 0 18px rgba(212,167,44,0.25)',
                        transition: 'all 0.2s',
