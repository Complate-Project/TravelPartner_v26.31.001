...
function TypeBadge({ type }: { type: 'user' | 'provider' }) {
    return (
        <span style={{
            ...
            border: `1px solid ${type === 'provider' ? 'rgba(212,167,44,0.3)' : 'rgba(212,167,44,0.3)'}`,
        }}>
                ...
                return (
                    <label
                        ...
                        style={{
                            ...
                            padding: '10px 12px',
                            borderRadius: '8px',
                            background: checked ? 'rgba(212,167,44,0.08)' : 'var(--bg-input)',
                            border: `1px solid ${checked ? 'rgba(212,167,44,0.3)' : 'var(--border-subtle)'}`,
                            cursor: 'pointer',
                    ...
                    >
                        ...
                        <span style={{
                            ...
                            background: checked ? 'rgba(212,167,44,0.15)' : 'transparent',
                            display: 'flex',
                            alignItems: 'center',
            ...
            <div key={pkg.id} className="card gold-top-edge" style={{ position: 'relative' }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '8px', flexWrap: 'wrap', borderTop: '1px solid var(--border-subtle)', paddingTop: '14px' }}>
                    <button
                        ...
                        style={{ color: 'var(--gold-mid)', borderColor: 'rgba(212,167,44,0.3)', display: 'flex', alignItems: 'center', gap: '6px' }}
                        onMouseEnter={e => { e.currentTarget.style.background = 'rgba(212,167,44,0.1)'; e.currentTarget.style.borderColor = 'rgba(212,167,44,0.5)'; }}
                        onMouseLeave={e => { e.currentTarget.style.background = ''; e.currentTarget.style.borderColor = 'rgba(212,167,44,0.3)'; }}
                    >
        ...
        <div style={{ marginBottom: '28px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '16px' }}>
                <span style={{
                    ...
                    background: 'var(--gold-glow)', border: '1px solid rgba(212,167,44,0.3)', flexShrink: 0,
                }}>
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="var(--gold-mid)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                <button
                    ...
                    style={{
                        ...
                        padding: '8px 14px',
                        background: showForm ? 'rgba(212,167,44,0.08)' : 'linear-gradient(135deg, #A9852A, #D4A72C)',
                        border: showForm ? '1px solid rgba(212,167,44,0.3)' : 'none',
                        borderRadius: '8px',
            ...
            {/* Feedback */}
            {error && <div style={{ padding: '10px 14px', background: 'rgba(239,68,68,0.08)', border: '1px solid rgba(239,68,68,0.25)', borderRadius: '8px', color: 'var(--red-status)', fontSize: '0.8rem', marginBottom: '14px' }}>⚠ {error}</div>}
            {success && <div style={{ padding: '10px 14px', background: 'rgba(16,185,129,0.08)', border: '1px solid rgba(16,185,129,0.25)', borderRadius: '8px', color: 'var(--green-status)', fontSize: '0.8rem', marginBottom: '14px' }}>✓ {success}</div>}

            {/* Create Form */}
            {showForm && (
                <div ref={formRef} className="card" style={{ marginBottom: '24px', position: 'relative', overflow: 'hidden' }}>
                    <div style={{ position: 'absolute', top: 0, left: 0, right: 0, height: '1px', background: 'linear-gradient(90deg, transparent, var(--gold-mid), transparent)' }} />
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '18px' }}>
                            <span style={{
                                ...
                                background: editingPkg ? 'var(--gold-glow)' : 'var(--gold-glow)',
                                border: `1px solid ${editingPkg ? 'var(--border-gold)' : 'rgba(212,167,44,0.3)'}`,
                                flexShrink: 0,
                            }}>
                                {editingPkg
                                    ...
                                    : <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="var(--gold-mid)" strokeWidth="2.5" strokeLinecap="round"><line x1="12" y1="5" x2="12" y2="19" /><line x1="5" y1="12" x2="19" y2="12" /></svg>}
                            </span>
                                    ...
                                    <button
                                        ...
                                        style={{
                                            ...
                                            background: pkgType === t
                                                ? (t === 'provider' ? 'rgba(212,167,44,0.08)' : 'rgba(212,167,44,0.08)')
                                                : 'var(--bg-input)',
                                            color: pkgType === t
                        ...
                        <button
                            ...
                            style={{
                                ...
                                background: submitting ? 'var(--bg-input)' : 'linear-gradient(135deg, #A9852A, #D4A72C)',
                                ...
                                transition: 'all 0.2s',
                                boxShadow: submitting ? 'none' : '0 0 20px rgba(212,167,44,0.35)',
                            }}
                        >
                    ...
                    <div style={{ marginBottom: '32px' }}>
                        <div style={{
                            ...
                            <span style={{
                                ...
                                borderRadius: '999px', background: 'rgba(212,167,44,0.12)',
                                color: '#818cf8', border: '1px solid rgba(212,167,44,0.3)',
                            }}>
                                {userPackages.length}
                            </span>
                        </div>
                    ...
                    <div>
                        <div style={{
                            ...
                            <span style={{
                                fontSize: '0.6rem', fontWeight: 700, padding: '2px 8px',
                                borderRadius: '999px', background: 'rgba(212,167,44,0.12)',
                                color: 'var(--gold-mid)', border: '1px solid rgba(212,167,44,0.3)',
                            }}>
            ...
            <div style={{ padding: 'clamp(90px, 22vw, 108px) clamp(12px, 4vw, 16px) clamp(32px, 8vw, 80px)', width: '100%', boxSizing: 'border-box' }}>
                ...
                <div style={{ marginBottom: '22px' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '4px' }}>
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="var(--gold-mid)" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" style={{ filter: 'drop-shadow(0 0 6px rgba(212,167,44,0.6))' }}>
                ...
                <div style={{ display: 'flex', background: 'var(--bg-nav)', borderRadius: '10px', padding: '4px', border: '1px solid var(--border-subtle)', marginBottom: '24px', gap: '4px' }}>
                    {([{ key: 'packages', label: '📦 Packages', color: 'var(--gold-mid)', bg: 'rgba(212,167,44,0.12)' }] as const).map(t => (
                        <button
                            key={t.key}
