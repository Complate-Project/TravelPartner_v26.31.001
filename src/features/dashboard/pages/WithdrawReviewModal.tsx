...
const STATUS_STYLE: Record<string, { color: string; bg: string; border: string }> = {
    Pending: { color: 'var(--gold-mid)', bg: 'rgba(212,167,44,0.12)', border: 'rgba(212,167,44,0.3)' },
    Approved: { color: 'var(--gold-mid)', bg: 'rgba(212,167,44,0.12)', border: 'rgba(212,167,44,0.3)' },
    ...
    return (
        ...
        >
            ...
            >
                ...
                {/* Approve form */}
                {showApprove && (
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', marginBottom: '16px', padding: '14px', borderRadius: '12px', background: 'rgba(212,167,44,0.05)', border: '1px solid rgba(212,167,44,0.25)' }}>
                        <p style={{ margin: 0, fontSize: '0.85rem', fontWeight: 800, color: 'var(--gold-mid)', fontFamily: "'Inter', sans-serif" }}>
                            Approve Withdrawal
                        </p>
                        <div>
                        ...
                        <div style={{ display: 'flex', gap: '10px', justifyContent: 'flex-end' }}>
                            ...
                            <button
                                ...
                                style={{
                                    padding: '9px 16px', borderRadius: '8px', border: 'none',
                                    background: 'linear-gradient(135deg,#A9852A,#D4A72C)', color: '#fff',
                                    fontSize: '0.68rem', fontWeight: 800, cursor: 'pointer',
