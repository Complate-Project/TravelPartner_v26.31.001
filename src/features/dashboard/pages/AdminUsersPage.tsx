            ...
            <motion.div initial="hidden" animate="visible" variants={containerAnim} className="container" style={{
                ...
                {loading && (
                    <div style={{
                        ...
                        <div className="spinner" style={{ width: 40, height: 40, borderRadius: '50%', border: '3px solid var(--border-subtle)', borderTop: '3px solid var(--gold-rich)', animation: 'spin 0.8s linear infinite' }} />
                        ...
                        <motion.div variants={fadeUp} style={{
                            ...
                            <button
                                ...
                                style={{
                                    ...
                                    fontFamily: 'var(--font-display)',
                                    cursor: 'pointer',
                                    background: activeTab === 'users' ? 'var(--gold-deep)' : 'transparent',
                                    color: activeTab === 'users' ? '#fff' : 'var(--text-muted)',
                                    transition: 'all var(--duration-fast)',
                                    borderBottom: activeTab === 'users' ? '2px solid var(--gold-mid)' : '2px solid transparent'
                                }}
                            >
