            ...
            <div style={{ padding: '100px 16px 16px', maxWidth: '860px', margin: '0 auto' }}>
                ...
                {membership && (
                    <motion.div variants={fadeUp} style={{
                        background: 'linear-gradient(135deg, rgba(212,167,44,0.10), rgba(212,167,44,0.04))',
                        border: '1px solid rgba(212,167,44,0.25)',
                        borderRadius: 16, padding: '20px 24px', marginBottom: 24,
                    }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 12 }}>
                            <div>
                                <p style={{ margin: '0 0 4px', fontSize: '0.6rem', letterSpacing: '0.14em', textTransform: 'uppercase', color: 'var(--text-muted)', fontWeight: 700 }}>Current Membership</p>
                                <p style={{ margin: 0, fontSize: '1.3rem', fontWeight: 800, color: 'var(--text-primary)', fontFamily: "'Inter', sans-serif" }}>{membership.package}</p>
                            </div>
                            <div style={{ textAlign: 'right' }}>
                                <p style={{ margin: '0 0 2px', fontSize: '0.6rem', letterSpacing: '0.12em', textTransform: 'uppercase', color: 'var(--text-muted)', fontWeight: 700 }}>Status</p>
                        ...
                        {hasActiveMembership && membership.expires_at && (
                            <div style={{ marginTop: 12 }}>
                                <p style={{ margin: '0 0 2px', fontSize: '0.6rem', letterSpacing: '0.12em', textTransform: 'uppercase', color: 'var(--text-muted)', fontWeight: 700 }}>Expires</p>
                        ...
                        {hasActiveMembership && activeFeatureLabels.length > 0 && (
                            <div style={{ marginTop: 16, paddingTop: 16, borderTop: '1px solid var(--border-subtle)' }}>
                                <p style={{ margin: '0 0 10px', fontSize: '0.6rem', letterSpacing: '0.12em', textTransform: 'uppercase', color: 'var(--text-muted)', fontWeight: 700 }}>Active Features</p>
                ...
                >
                    <div style={{ display: 'flex', gap: '10px', alignItems: 'flex-start' }}>
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none"
                            stroke="var(--gold-mid)" strokeWidth="2" style={{ flexShrink: 0, marginTop: '2px' }}>
                ...
                {error && (
                    <motion.div variants={fadeUp} className="card" style={{
                        ...
                        color: 'var(--red-status)', fontSize: '0.85rem',
                    }}>
                        ⚠ {error}
                    </motion.div>
                )}
