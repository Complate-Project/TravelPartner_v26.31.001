...
function StatusLabel({ status, error }: { status: string; error?: string | null }) {
    ...
    return (
        <p style={{
            color: status === 'error' ? '#ef4444' : 'var(--text-secondary)',
...
const CALL_BG = 'radial-gradient(ellipse at 50% 0%, var(--bg-card) 0%, var(--bg-main) 60%, var(--bg-main) 100%)';
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    boxShadow: isPreConnection
                        ? '0 0 0 6px rgba(212,167,44,0.25), 0 12px 48px rgba(0,0,0,0.5)'
                ...
                {isConnecting ? (
                    ...
                    <div style={{ textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 8 }}>
                        ...
                        {connectionLost ? (
                            ...
                            <span style={{ color: '#D4A72C', fontSize: '0.8rem', fontWeight: 600 }}>
                                Reconnecting...
                            </span>
