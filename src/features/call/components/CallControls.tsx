        ...
        <div style={{
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                <button
                    ...
                    style={{
                        ...btnBase,
                        background: isMuted ? 'rgba(239,68,68,0.2)' : 'var(--bg-input)',
                        color: isMuted ? '#ef4444' : 'var(--text-primary)',
                        border: isMuted ? '2px solid rgba(239,68,68,0.4)' : '2px solid var(--border-default)',
                    }}
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                <button
                    ...
                    style={{
                        ...btnBase,
                        background: isSpeakerOn ? 'rgba(212,167,44,0.2)' : 'var(--bg-input)',
                        color: isSpeakerOn ? '#D4A72C' : 'var(--text-primary)',
                        border: isSpeakerOn ? '2px solid rgba(212,167,44,0.4)' : '2px solid var(--border-default)',
                    }}
                    onMouseDown={e => { e.currentTarget.style.transform = 'scale(0.92)'; }}
                    onMouseUp={e => { e.currentTarget.style.transform = 'scale(1)'; }}
                    onTouchStart={e => { e.currentTarget.style.transform = 'scale(0.92)'; }}
