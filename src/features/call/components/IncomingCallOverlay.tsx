...
const BG = 'radial-gradient(ellipse at 50% 30%, var(--bg-card) 0%, var(--bg-main) 50%, var(--bg-main) 100%)';
    ...
    return (
        <div style={{
            ...
            <style>{`
                ...
                @keyframes ringPulse{0%{box-shadow:0 0 0 0 rgba(212,167,44,0.4)}100%{box-shadow:0 0 0 32px rgba(212,167,44,0)}}
            `}</style>
            ...
            <div style={{
                ...
                <div style={{ position: 'relative', animation: 'slideUp 0.35s ease' }}>
                    ...
                    <div style={{
                        ...
                        boxShadow: '0 0 0 6px rgba(212,167,44,0.2), 0 16px 48px rgba(0,0,0,0.5)',
                ...
                <div style={{ textAlign: 'center', animation: 'slideUp 0.35s ease 0.05s both' }}>
                    <h2 style={{ color: 'var(--text-primary)', fontSize: '1.75rem', fontWeight: 700, margin: '0 0 6px', letterSpacing: '-0.02em', lineHeight: 1.3 }}>
                        {callState.peerName}
                    </h2>
                    {callState.peerRole && (
                        <span style={{ display: 'inline-block', marginBottom: 6, padding: '2px 12px', borderRadius: 999, fontSize: '0.7rem', fontWeight: 600, letterSpacing: '0.06em', color: 'var(--text-secondary)', background: 'var(--bg-input)', border: '1px solid var(--border-default)' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 56, animation: 'slideUp 0.35s ease 0.1s both', paddingBottom: 8 }}>
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 10 }}>
                        ...
                        <span style={{ color: 'var(--text-secondary)', fontSize: '0.75rem', fontWeight: 600, letterSpacing: '0.05em' }}>DECLINE</span>
                    </div>
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 10 }}>
                        ...
                        <span style={{ color: 'var(--text-secondary)', fontSize: '0.75rem', fontWeight: 600, letterSpacing: '0.05em' }}>ACCEPT</span>
                    </div>
                </div>
            </div>
        </div>
