            ...
            <div style={{
                ...
                {!loading && statusError && (
                    <div>
                        ...
                        <p style={{ textAlign: 'center', fontFamily: "'Inter', sans-serif", fontSize: '0.8rem', color: 'var(--text-primary)' }}>
                ...
                {!loading && !statusError && setupCompleted && (
                    <div>
                        <div style={{
                            ...
                            color: 'var(--gold-deep)', fontSize: '0.85rem', fontFamily: "'Inter', sans-serif",
                ...
                {!loading && !statusError && setupCompleted === false && (
                    <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                        <p style={{
                            ...
                            background: 'rgba(212,167,44,0.08)', border: '1px solid rgba(212,167,44,0.25)',
                        ...
                        <div>
                            ...
                            <input
                                ...
                                type="email"
                                placeholder="admin@travelpartner.com"
                                value={email}
