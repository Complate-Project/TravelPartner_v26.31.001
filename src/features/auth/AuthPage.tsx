            ...
            <div style={{
                ...
                {error && (
                    <div style={{
                        ...
                        color: 'var(--red-status)', fontSize: '0.8rem', fontFamily: "'Inter', sans-serif",
                        marginBottom: '18px',
                    }}>{error}</div>
                )}
                        ...
                        {isLogin && (
                            <div style={{ textAlign: 'right', marginTop: '8px' }}>
                                <Link
                                    to="/forgot-password"
                                    style={{
                                        fontSize: '0.75rem', color: 'var(--gold-mid)',
                ...
                <p style={{
                    ...
                    {isLogin ? (
                        <>New to Travel Partner?{' '}
                            <Link to="/signup" style={{ color: 'var(--gold-mid)', textDecoration: 'none', fontWeight: 500 }}>
                                Create an account
                            </Link>
                        </>
                    ) : (
                ...
                {isLogin && (
                    <p style={{
                        ...
                        fontSize: '0.72rem', fontFamily: "'Inter', sans-serif", color: 'var(--text-primary)',
                    }}>
                        Are you a service provider?{' '}
                        <Link to="/provider/register" style={{ color: 'var(--gold-mid)', textDecoration: 'none', fontWeight: 500 }}>
                            Register here
                        </Link>
                    </p>
                )}

                {/* Admin portal link removed from normal login page to prevent discoverability. */}
