...
function StoreIcon() {
    return (
        <svg viewBox="0 0 24 24" width="26" height="26" fill="none" stroke="#D4A72C" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
    ...
    return (
        <button
            ...
            style={{
                ...
                borderRadius: 12,
                background: selected ? 'rgba(212,167,44,0.14)' : 'var(--bg-input)',
        ...
        >
            <span style={{ width: 34, height: 34, borderRadius: 8, overflow: 'hidden', background: 'var(--bg-input)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                {logo}
            </span>
                                    ...
                                    {selected!.method === 'merchant' && (
                                        <div style={{ marginTop: 8, borderRadius: 8, overflow: 'hidden', border: '1px solid var(--border-subtle)' }}>
                                            <img
                                                ...
                                                style={{ width: '100%', maxHeight: 220, objectFit: 'contain', background: 'var(--bg-input)', display: 'block' }}
                                            />
                                        </div>
                                    )}
                                </>
