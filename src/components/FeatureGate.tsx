...
export const FeatureGate: React.FC<FeatureGateProps> = ({
    ...
    if (loading) {
        return (
            <div style={{
                ...
                padding: '40px', color: 'var(--text-secondary)', fontSize: '0.85rem',
            }}>
                Checking access…
            </div>
        );
        ...
        return (
            <div style={{
                ...
                <div style={{
                    ...
                    background: 'linear-gradient(135deg, rgba(212,167,44,0.15), rgba(139,92,246,0.15))',
    ...
    return (
        <div style={{
            padding: '20px 16px',
            borderRadius: 12,
            border: '1px dashed rgba(212,167,44,0.3)',
            ...
            <p style={{ margin: 0, fontSize: '0.82rem', fontWeight: 700, color: 'var(--text-primary)', fontFamily: "'Inter', sans-serif" }}>
